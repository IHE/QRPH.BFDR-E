...
Profile: IHECompositionProviderLiveBirthReport
Parent: Composition
Id: Composition-provider-live-birth-report-ihe
...
* extension contains
    $Extension-live-birth-certificate-number named liveBirthCertificateNumber 0..1 MS and
...
* type = $loinc#68998-4
* type MS
* type ^short = "U.S. standard certificate of live birth - 2003 revision"
* type ^definition = "U.S. standard certificate of live birth - 2003 revision"
* subject 1.. MS
* subject only Reference(Patient-child-ihe-vr)
* subject ^short = "The subject of the composition is the newborn baby: the \"US Standard Mothers Worksheet for Child’s Birth Certificate\" should be the source of truth for the baby's name."
...
* encounter.extension ^short = "The Encounter is the maternity encounter."
* date MS
...
* section[motherPrenatal].focus ^short = "The focus of this section is the mother: the \"US Standard Mothers Worksheet for Child’s Birth Certificate\" should be the source of truth for the mother's name, address, dob, birthplace, race, and ethnicity."
...
* section[motherPrenatal].entry[mothersHeight] only Reference(Observation-mother-height-ohe-vr)
* section[motherPrenatal].entry[mothersHeight] ^short = "Mother's height: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
...
* section[motherPrenatal].entry[mothersPrepregnancyWeight] ^short = "Mother's prepregnancy weight: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
...
* section[motherPrenatal].entry[motherReceivedWICFood] ^short = "Use of the WIC nutritional program by the mother: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
...
* section[motherPrenatal].entry[cigaretteSmokingBeforeDuringPregnancy] ^short = "Cigarettes smoked by the mother before and during the pregnancy: the \"US Standard Mothers Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
...
* section[newbornInformation].entry MS
...
* section[motherInformation].entry ^slicing.discriminator.path = "resolve()"
...
* section[fatherInformation].focus ^short = "The focus of this section is the father: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for the father's name, dob, birthplace, ssn, race, and ethncity."
...
* section[fatherInformation].entry MS
...
* section[fatherInformation].entry[paternityAcknowledgementSigned] ^short = "Paternity acknowledgement signed by father: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
...
* section[fatherInformation].entry[fathersEducation] ^short = "Father's education: the \"US Standard Mother's Worksheet for Child’s Birth Certificate\" should be the source of truth for this data element."
